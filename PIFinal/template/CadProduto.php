...
<head>
    ...
    <title>Agily Stock - Cadastro de Produto</title>
...
<div class="content">
    ...
    <form id="form-cadastro-produto">
        <table class="table table-bordered bg-white">
            ...
            <tbody>
                <tr>
                    <td><input id="codProduto" name="codProduto" type="text" class="form-control" placeholder="123" required maxlength="10"></td>
                    ...
                    <td><input id="produto" name="produto" type="text" class="form-control" placeholder="Maça" required maxlength="40"></td>
