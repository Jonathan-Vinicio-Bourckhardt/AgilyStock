...
<div class="content">
    ...
    <div class="history-container">
        <table class="table table-striped history-table">
            ...
            <tbody>
                <?php
                    // 🛑 AÇÃO DE ISOLAMENTO: Filtrar o SELECT pelo ID da empresa logada 🛑
                    // Reabre a conexão se ela foi fechada no processamento POST (o que não deve acontecer, mas é bom garantir)
                    if (!isset($conn) || !$conn->ping()) {
                        // Certifique-se de que a conexão é reaberta se necessário
                        // Nota: A função validaCNPJ não exige $conn, mas o SELECT a seguir sim.
                        include 'conexao.php';
                    }
